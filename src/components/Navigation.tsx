...
import {
    ...
    HomeRounded, KeyboardArrowRight, KeyboardArrowRightRounded, Money, PeopleAltRounded,
    ReceiptRounded,
            ...
            <ListItem nested sx={{ p: 0 }}>
                ...
                >
                    ...
                    >
                        ...
                        {open ? <KeyboardArrowDownRoundedIcon fontSize="small" color="primary" /> : <KeyboardArrowRightRounded fontSize="small" color="primary" />}
                    </IconButton>
                </Box>
                { open ?
                    <List
                    ...
                    >
                            ...
                            <ListItem sx={{mb: ".5em"}}>
                                ...
                                >
                                    <ListItemDecorator sx={{ color: 'inherit' }}>
                                        <DashboardRounded color={index === 0 ? "action" : "action"} fontSize="large" />
                                    </ListItemDecorator>
                        ...
                        <Link style={{textDecoration: "none"}} to={"/import-data"}>
                            <ListItem sx={{mb: ".5em"}}>
                                ...
                                >
                                    <ListItemDecorator sx={{ color: 'inherit' }}>
                                        <CloudDownloadRounded color={index === 1 ? "primary" : "action"} fontSize="large" />
                                    </ListItemDecorator>
                                    <ListItemContent sx={{mt: "0.2em"}}>Module d'import</ListItemContent>
                                </ListItemButton>
                            </ListItem>
                        </Link>
                        <ListItem onClick={() => setDataSubmenu(!dataSubmenu)} sx={{mb: ".5em", display: 'flex', flexDirection: 'row', alignItems: 'center'}}>
                                <ListItemButton
                                    selected={index === 2}
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        {dataSubmenu ? <KeyboardArrowDownRoundedIcon fontSize="small" color="action" /> : <KeyboardArrowRightRounded fontSize="small" color="action" />}
                                    </IconButton>
                                </ListItemButton>
                            </ListItem>
                        {dataSubmenu ?
                                    ...
                                    <ListItem  sx={{mb: ".2em", display: 'flex', flexDirection: 'row', alignItems: 'center'}}>
                                        ...
                                        >
                                            <ListItemDecorator sx={{color: 'grey'}}>
                                                <ShoppingCartRounded color={index === 3 ? "secondary" : "action"} fontSize="large"/>
                                            </ListItemDecorator>
                                ...
                                <Link style={{textDecoration: "none"}} to={"/data/banque"}>
                                    <ListItem  sx={{mb: "1em", display: 'flex', flexDirection: 'row', alignItems: 'center'}}>
                                        ...
                                        >
                                            ...
                                            <ListItemContent sx={{mt: "0.2em"}}>Opérations bancaires</ListItemContent>
                                        </ListItemButton>
                                    </ListItem>
                                </Link>
                                <Link style={{textDecoration: "none"}} to={"/data/banque"}>
                                    <ListItem  sx={{mb: "1em", display: 'flex', flexDirection: 'row', alignItems: 'center'}}>
                                        ...
                                        >
                                            ...
                                            <ListItemContent sx={{mt: "0.3em"}}>Clients/Fournisseurs</ListItemContent>
                                        </ListItemButton>
                                    </ListItem>
                                </Link>
                            </Box>
